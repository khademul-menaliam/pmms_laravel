            ...
            <nav class="sidebar-nav">
                @foreach ($navItems as $item)
                    ...
                    >
                        ...
                        @if ($item['route'] === 'reminders.index' && $pendingAlertsCount)
        ...
        <div class="main-shell">
            <header class="topbar">
                ...
                <div class="topbar-actions">
                    <a href="{{ route('incomes.create') }}" class="btn btn-soft">+ Income</a>
                    <a href="{{ route('expenses.create') }}" class="btn btn-primary">+ Expense</a>
